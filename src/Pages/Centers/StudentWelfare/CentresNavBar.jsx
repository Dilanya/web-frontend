...
export default function CentresNavBar(params) {
    ...
    if (currentLocation.startsWith("/centres/student-welfare-centre")) {
      DepartmentNameEnglish = "Student Welfare Centre";
    } else {
    ...
    return(
        <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                  ...
                  >
                    <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href='/centres/student-welfare-centre'>
                          Home
                        </a>
                      </li>
